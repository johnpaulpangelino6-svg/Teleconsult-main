...
<main class="main">
    <div class="page-header">
        ...
        <p>Manage your professional and personal information</p>
    </div>
    ...
    <form method="POST" enctype="multipart/form-data" id="profileForm" class="profile-container">
        <div class="profile-card-left">
            ...
            <span class="profile-role">Medical Professional</span>
        ...
        <div class="profile-content-right">
            ...
            <div class="info-section">
                <div class="section-header"><h3>Medical Background</h3></div>
                <div class="grid-fields">
